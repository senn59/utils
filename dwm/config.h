...
static const char col_cyan[]        = "#FF4D4D";
...
/*1 by default but changed to prevent terminal windows from not sizing correctly */
...
static Key keys[] = {
	...
	{ MODKEY,                       XK_j,      focusstack,     {.i = +1 } },	/* j [cycle down  windows] */
	{ MODKEY,                       XK_k,      focusstack,     {.i = -1 } },	/* k [cycle up windows] */
	...
	{ MODKEY,                       XK_comma,  focusmon,       {.i = -1 } },/* multi monitor tings */
